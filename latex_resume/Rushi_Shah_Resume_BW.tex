...
\cventry{{\color{color1}The MITRE Corporation}}{Research Intern}{Federal Aviation Administration Department}{}{{\color{color1}Python}}{
	\begin{description}
	  \item[Summer 2014] - Northern Virgnia \hfill \\
	  	...
	  	\hspace*{.5cm} - Analyze emerging patterns in 12,000 air traffic controller transmissions
...
\cventry{\large{Haskell}}{Beginners Luck}{}{blockchain cryptocurrency trading bot for Ethereum}{\newline{} \url{https://github.com/2016rshah/beginners-luck}}{}
