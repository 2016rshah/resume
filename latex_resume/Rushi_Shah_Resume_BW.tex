...
\cventry{{\color{color1}Originate}}{Computer Science Intern}{}{}{{\color{color1}Haskell}}{
	\begin{description}
		\item[Summer 2017 (planned)] - based in New York City office.
	\end{description}
}

\hfill 

\cventry{{\color{color1}The MITRE Corporation}}{CS Research Intern}{Federal Aviation Administration Department}{}{{\color{color1}Python}}{
	\begin{description}
	  \item[Summer 2014] \hfill \\
	  	...
	  	- Created computational linguistics algorithms for  call-sign identification. \newline
...
\cventry{{\color{color1}Nclud}}{Web-Development Intern}{}{}{{\color{color1}Javascript (ThreeJS animations \& MeteorJS)}}{
	\begin{description}
	  \item[Spring 2015] - based in Washington DC headquarters. \newline
